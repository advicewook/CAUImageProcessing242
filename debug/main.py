import cv2
import os
from text_highlighter import convert_to_grayscale, apply_adaptive_threshold, custom_image_to_data, get_word_coordinates, highlight_text, subprocess, draw_rectangle, preprocess_image
...
def main():
    ...
    # preprocessing test
    # resize = preprocess_image(image_path, script_dir)
    ...
    try:
        ...
        data = custom_image_to_data(image_path)
